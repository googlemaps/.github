...
public interface RouteLegOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.maps.routes.v1.RouteLeg)
   ...
   */
  java.util.List<com.google.maps.routes.v1.RouteLegStep> 
      getStepsList();
  /**
   * <pre>
   * An array of steps denoting segments within this leg. Each step represents
   ...
   * <code>repeated .google.maps.routes.v1.RouteLegStep steps = 7;</code>
   */
  com.google.maps.routes.v1.RouteLegStep getSteps(int index);
  /**
   * <pre>
   * An array of steps denoting segments within this leg. Each step represents
   * one navigation instruction.
   ...
   * <code>repeated .google.maps.routes.v1.RouteLegStep steps = 7;</code>
   */
  java.util.List<? extends com.google.maps.routes.v1.RouteLegStepOrBuilder> 
   ...
   * <code>repeated .google.maps.routes.v1.RouteLegStep steps = 7;</code>
   */
  com.google.maps.routes.v1.RouteLegStepOrBuilder getStepsOrBuilder(
      int index);
   ...
   */
  com.google.maps.routes.v1.RouteLegTravelAdvisory getTravelAdvisory();
  /**
   * <pre>
   * Encapsulates the additional information that the user should be informed
   * about, such as possible traffic zone restriction etc. on a route leg.
   ...
   * <code>.google.maps.routes.v1.RouteLegTravelAdvisory travel_advisory = 8;</code>
   */
  com.google.maps.routes.v1.RouteLegTravelAdvisoryOrBuilder getTravelAdvisoryOrBuilder();
}
