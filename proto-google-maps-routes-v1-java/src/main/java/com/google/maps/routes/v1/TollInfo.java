...
private static final long serialVersionUID = 0L;
  ...
  public static final int ESTIMATED_PRICE_FIELD_NUMBER = 2;
   ...
   * </pre>
   *
   * <code>repeated .google.type.Money estimated_price = 2;</code>
   */
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < estimatedPrice_.size(); i++) {
      output.writeMessage(2, estimatedPrice_.get(i));
    }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < estimatedPrice_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(2, estimatedPrice_.get(i));
    }
